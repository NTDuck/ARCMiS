...
| [code-clarity.md](code-clarity.md) | Show the module map first. Small named functions. Do not mix abstraction levels. | `lint-rules.py` (advisory: files over 300 lines) + enforced in review |
